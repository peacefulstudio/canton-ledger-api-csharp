...
public class RestContractStreamProjectorInterfaceViewTests
{
    ...
    {
        public static RuntimeIdentifier TemplateId { get; } = new("tmpl-pkg", "Sample.Token", "ViewTestsHolding");
        ...
        public DamlRecord ToRecord() => DamlRecord.Create(DamlField.Create("amount", new DamlText(Amount)));

        public static DamlRecord __ReadDamlLfJson(JsonElement json, DamlLfJsonDecodeContext context) =>
            TestRecordReader.Read(
                json,
                context,
                ("amount", DamlLfJsonDecoders.ReadText));
        ...
        : ITemplate, IDamlRecord<ImplementingTemplateMarker>, IHasKey<ImplementingTemplateMarker, AccountKey>
    {
        ...
        public static KeyDescriptor<ImplementingTemplateMarker, AccountKey> Key { get; } = new()
        {
            ...
            KeyJsonReader = AccountKey.__ReadDamlLfJson,
        };
        ...
        [property: DamlFieldAttribute("label")] string Label) : IDamlRecord<AccountKey>
    {
        ...
        public static DamlRecord __ReadDamlLfJson(JsonElement json, DamlLfJsonDecodeContext context) =>
            TestRecordReader.Read(
                json,
                context,
                ("custodian", DamlLfJsonDecoders.ReadParty),
                ("label", DamlLfJsonDecoders.ReadText));
    ...
    private static string CreatedEventJson(
        ...
        string offset = "42",
        bool includeCreateArgument = true) =>
        $$"""
        {
          "offset": "{{offset}}",
          "nodeId": 0,
          ...
          {{(includeCreateArgument ? $@"""createArgument"": {CreateArgumentJson}," : string.Empty)}}
    ...
    public async Task ProjectActiveContractEntry_decodes_the_participant_computed_view_for_an_interface_marker()
    {
        ...
        var projected = RestInterfaceStreamProjector.ProjectActiveContractEntry<InterfaceMarker, InterfaceMarkerView>(response)
    ...
    public async Task ProjectActiveContractEntry_decodes_a_circe_shaped_view_value_against_the_view_type()
    {
        ...
        RestMarkerMatcher<InterfaceMarker>.TryGetInterfaceViewRecord<InterfaceMarkerView>(created, out var view)
            .Should().BeTrue();
    ...
    [Fact]
    public async Task ProjectActiveContractEntry_yields_a_decode_failure_when_the_create_argument_is_missing_from_an_otherwise_decodable_interface_view()
    {
        var response = await ActiveContractsResponseFrom(CreatedEventJson(ComputedViewJson, includeCreateArgument: false));
    ...
    [Fact]
    public void ProjectTransactionEvents_yields_a_decode_failure_when_the_create_argument_is_missing_from_an_otherwise_decodable_interface_view()
    {
        var transaction = TransactionFrom(CreatedEventJson(ComputedViewJson, includeCreateArgument: false));

        var projected = RestInterfaceStreamProjector.ProjectTransactionEvents<InterfaceMarker, InterfaceMarkerView>(transaction)
            .Should().ContainSingle().Subject;
    ...
    [Fact]
    public void ProjectReassignmentEvents_Assigned_yields_a_decode_failure_when_the_create_argument_is_missing_from_an_otherwise_decodable_interface_view()
    {
        var reassignment = ReassignmentFrom(CreatedEventJson(ComputedViewJson, includeCreateArgument: false));

        var projected = RestInterfaceStreamProjector.ProjectReassignmentEvents<InterfaceMarker, InterfaceMarkerView>(reassignment)
            .Should().ContainSingle().Subject;
    ...
    public async Task ProjectActiveContractEntry_still_projects_the_create_argument_for_a_template_marker()
    {
        var response = await ActiveContractsResponseFrom(CreatedEventJson(
            ComputedViewJson,
            templateIdJson: """{"packageId": "tmpl-pkg", "moduleName": "Sample.Token", "entityName": "ViewTestsHolding"}"""));

        var projected = RestContractStreamProjector.ProjectActiveContractEntry<TemplateMarker>(response)
            .Should().ContainSingle().Subject;

        var created = projected.Should().BeOfType<ContractStreamEvent<TemplateMarker>.Created>().Subject;
        created.Payload.Amount.Should().Be("create-argument-value");
    }
    ...
    public void ProjectTransactionEvents_still_projects_the_create_argument_for_a_template_marker()
    {
        ...
        var projected = RestContractStreamProjector.ProjectTransactionEvents<TemplateMarker>(transaction)
            .Should().ContainSingle().Subject;
    ...
    public async Task ProjectActiveContractEntry_yields_Unclassified_when_no_view_matches_the_subscribed_interface()
    {
        var response = await ActiveContractsResponseFrom(CreatedEventJson(
            """
            {
              ...
              "viewStatus": {"code": 0, "message": ""},
              "viewValue": {"amount": "other-view-value"}
            }
            """));
    ...
    public void ProjectReassignmentEvents_Assigned_still_projects_the_create_argument_for_a_template_marker()
    {
        ...
        var projected = RestContractStreamProjector.ProjectReassignmentEvents<TemplateMarker>(reassignment)
            .Should().ContainSingle().Subject;
        ...
        assigned.Payload.Amount.Should().Be("create-argument-value");
    }
}

...
public class RestCommandBuilderTests
{
    ...
    {
        public static RuntimeIdentifier TemplateId { get; } = new("pkg", "Module", "CommandBuilderTemplate");
    ...
    private static RuntimeCommands.CreateCommand Create() =>
        new(new RuntimeIdentifier("pkg", "Module", "CommandBuilderTemplate"), new DamlRecord(null, []));

    private static RuntimeCommands.ExerciseCommand Exercise(string choice = "Archive", string cid = "00contract123") =>
        new(
            new RuntimeIdentifier("pkg", "Module", "CommandBuilderTemplate"),

...
public class RestContractStreamProjectorTransactionEventsTests
{
    ...
    {
        public static RuntimeIdentifier TemplateId { get; } = new("tmpl-pkg", "Sample.Token", "ScalarKeyedHolding");
        public static string PackageId => "tmpl-pkg";
        public static string PackageName => "token-impl";
        public static Version PackageVersion { get; } = new(0, 1, 0);
        public static DamlTypeDescriptor DamlTypeId { get; } = new(TemplateId, DamlTypeKind.Template, PackageName);
    ...
    public void ProjectTransactionEvents_populates_Created_Key_from_the_wire_contract_key_and_hash()
    {
        ...
        var created = RestContractStreamProjector.ProjectTransactionEvents<TemplateMarker>(transaction)
    ...
    public void ProjectTransactionEvents_populates_Created_Key_from_a_bare_scalar_wire_contract_key()
    {
                    ...
                    "events": [
                      {
                        "CreatedEvent": {
                          "offset": "7",
                          "contractId": "00keyed",
                          "templateId": {"packageId": "tmpl-pkg", "moduleName": "Sample.Token", "entityName": "ScalarKeyedHolding"},
                          "createArgument": {"owner": "alice::ns1"},
                          "contractKey": "alice::ns1",
                          "contractKeyHash": "AQID",
                          "witnessParties": ["alice::ns1"]
        ...
        var created = RestContractStreamProjector.ProjectTransactionEvents<ScalarKeyedMarker>(transaction)
            .Should().ContainSingle().Subject
    ...
    public void ProjectTransactionEvents_leaves_Created_Key_null_when_the_wire_carries_no_key()
    {
        ...
        RestContractStreamProjector.ProjectTransactionEvents<TemplateMarker>(transaction)
            .Should().ContainSingle().Subject
            .Should().BeOfType<ContractStreamEvent<TemplateMarker>.Created>().Subject
            .Key.Should().BeNull();
    }
    ...
    public void ProjectTransactionEvents_surfaces_an_exercised_event_missing_a_payload_as_Unclassified_decode_failure(

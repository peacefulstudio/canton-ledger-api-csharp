...
public class GrpcMarkerMatcherTests
{
    [Fact]
    public void ResolveMarkerIdentity_throws_when_marker_is_neither_interface_nor_template()
    {
        var act = () => GrpcMarkerMatcher<NeitherMarker>.StreamFilterIdentifier();
    ...
    {
        var filter = GrpcMarkerMatcher<IViewedInterfaceMarker>.StreamFilterIdentifier();
    ...
    {
        GrpcMarkerMatcher<IViewedInterfaceMarker>.IsInterface.Should().BeTrue();
    }

...
This package provides low-level gRPC client stubs generated from the official Canton Ledger API protobuf definitions (Canton Ledger API version 3.5.18). It enables direct communication with Canton participant nodes.
...
Generated from Canton Ledger API protos version 3.5.18 (downloaded from Maven Central at build time).

...
internal static class RestMarkerMatcher<TMarker>
    where TMarker : IDamlType
{
    ...
    /// constant in <c>GrpcMarkerMatcher</c>.
    /// </summary>
    ...
    /// <c>GrpcMarkerMatcher</c>. Returns <see langword="false"/> when the matched view carries no
